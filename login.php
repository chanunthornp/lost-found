...
<div class="w3-card-4">
  ...
  <form action="logincon.php" method="POST" class="w3-container" ">
    <p>      
    <p>
    ...
    <p>
    	<center>
    <input type="submit"  a href="index.php" value="ยกเลิก"></button></a>
    <input type="submit" name="Login" value="เข้าสู่ระบบ"></button></a> </p>   
</p>
</center>
  </form>
</div>
